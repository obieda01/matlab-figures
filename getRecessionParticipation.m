%% getRecessionParticipation
% 
% Return dates of recessions in the United States, 1951–2019
%
%% Syntax
%
...
function [startRecession, endRecession, nRecession] = getRecessionParticipation()

% Read month numbers for start and end of recessions
startRecession = readmatrix('data.xlsx', 'Sheet', 'Recession dates', 'Range', 'C26:C37');
endRecession = readmatrix('data.xlsx', 'Sheet', 'Recession dates', 'Range', 'D26:D37');
