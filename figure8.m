...
%% Description
%
% This script produces figure 8. The figure displays the Beveridge curve in the United States, 2001–2022.
%
%% Output
%
...
% % Highlight special inefficiently tight months: Feb. 2020, May 2021, Dec. 2022
% nMonth = length(u);
% specialTight = [nMonth - 34, nMonth - 19, nMonth];
% plot(u(specialTight), v(specialTight), lightOrangeSetting{:})

% % Highlight special inefficiently slack months: Oct. 2009, Apr. 2020
% specialSlack = [10+8*12, nMonth - 32];
